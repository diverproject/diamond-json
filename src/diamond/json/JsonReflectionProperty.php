...
class JsonReflectionProperty implements JsonReflectionAttribute
{
	...
	private function init(): void
	{
		...
		if (($value = $this->getReflectionProperty()->getValue($this->getObject())) !== null)
		{
			$annotation = new VarAnnotation;
			$annotation->setStatic(false);
			$annotation->setType(is_object($value) ? get_class($value) : gettype($value));
			$annotation->setDescription('generated by JsonReflectionProperty for not found a PHP Doc');
			$this->initSetType($annotation);
		}
	...
	{
		$class_name = nvl(AnnotationParser::getFirstMultiType($annotation->getType(), false), $this->getPropertyType());
	...
	{
		$this->getReflectionProperty()->setAccessible(true);
		$value = $this->getReflectionProperty()->getValue($this->getObject());
		$this->getReflectionProperty()->setAccessible(false);
